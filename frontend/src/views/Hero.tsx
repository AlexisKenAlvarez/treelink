...
import { SiPrisma, SiGraphql } from "react-icons/si";
    ...
    <div className="p-5">
      ...
      <div className="mt-32" id="showcase">
        <div className="text-center space-y-3">
          ...
          <p className="">
            Choose your own background and find the best one that will fit your
            style.
          </p>
        </div>
        ...
        <div className="w-fit mt-10 relative">
          ...
          <Marquee className="[--duration:20s]">
            {showcase.map((user) => (
              <Image key={user} alt={user} src={`/showcase/${user}.png`} width={300} height={300} className="rounded-lg" />
            ))}
          </Marquee>
        </div>
      </div>
